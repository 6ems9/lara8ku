@extends('layouts.sbadmin.main', ['title' => 'All Tag'])
@push('styles')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="modaltitle">Create New Tag</h6>
                    ...
                    <div class="modal-body">
                        <form id="form-add" action="#" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Tag Name" required />
                                @error('name')
